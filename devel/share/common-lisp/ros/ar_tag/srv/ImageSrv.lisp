...
(cl:defmethod cl:initialize-instance :after ((m <ImageSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ar_tag-srv:<ImageSrv-request> is deprecated: use ar_tag-srv:ImageSrv-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <ImageSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ar_tag-srv:<ImageSrv-response> is deprecated: use ar_tag-srv:ImageSrv-response instead.")))

(cl:ensure-generic-function 'image_data-val :lambda-list '(m))
(cl:defmethod image_data-val ((m <ImageSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ar_tag-srv:image_data-val is deprecated.  Use ar_tag-srv:image_data instead.")
  (image_data m))
