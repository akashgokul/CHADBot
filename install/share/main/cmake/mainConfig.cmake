...
if("FALSE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/cc/ee106a/fa19/class/ee106a-afu/ros_workspaces/Thanos/src/main)
  set(main_DEVEL_PREFIX /home/cc/ee106a/fa19/class/ee106a-afu/ros_workspaces/Thanos/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/cc/ee106a/fa19/class/ee106a-afu/ros_workspaces/Thanos/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa19/class/ee106a-afu/ros_workspaces/Thanos/install/${idir}'.  ${_report}")
    endif()
