...
class PathPlanner(object):
    ...
    def plan_to_joint_zero(self):
        """
        Generates a plan given an end effector angle subject to orientation constraints

        Inputs:
        theta: angle of wrist
        ...
        self._group.set_joint_value_target(joint_goal_zero)
    ...
    def plan_to_joint_default(self):
        """
        Generates a plan given an end effector angle subject to orientation constraints
        ...
        # print(self._group.get_current_joint_values())
        # joint_goal = [0,0,0,0,0,0,0]
        self._group.set_joint_value_target(joint_goal_default)
    ...
    def plan_to_joint(self, joint_goal):
        """
        Generates a plan given an end effector angle subject to orientation constraints
        ...
        self._group.set_joint_value_target(joint_goal)
